...
import { X, Plus, Edit, Trash2, User, Mail, BookOpen, GraduationCap, Target, AlertCircle, Save, Users } from "lucide-react"
...
export function StudentManagement({
  ...
  const addArrayItem = (field: "subjects" | "learning_goals" | "current_gaps", value: string) => {
    if (value.trim()) {
      setFormData((prev) => ({
        ...prev,
  ...
  const removeArrayItem = (field: "subjects" | "learning_goals" | "current_gaps", index: number) => {
    setFormData((prev) => ({
      ...prev,
            ...
            {student.subjects && student.subjects.length > 0 && (
              <div className="mb-4">
                <div className="flex items-center space-x-1 mb-2">
                  ...
                  <p className="text-white/50 text-xs font-medium">SUBJECTS</p>
                </div>
                <div className="flex flex-wrap gap-2">
                  ...
                  {student.subjects.length > 3 && (
                    <Badge 
                      variant="secondary" 
                      className="text-xs bg-gradient-to-r from-purple-500/20 to-blue-500/20 text-purple-300 border-purple-400/30"
                    >
